...
if (userNumber !== -1) {
    ...
    if (randomComputerNumber === 0 && userNumber === 2) {
        message = `Player chose: ${userInput.toLowerCase()} Computer chose: ${arr[randomComputerNumber]} Computer Won!`
    } else if (userNumber === 0 && randomComputerNumber === 2) {
        message = `Player chose: ${userInput.toLowerCase()} Computer chose: ${arr[randomComputerNumber]} Player Won!`
    ...
    message = "You enterd invalid option"
}
